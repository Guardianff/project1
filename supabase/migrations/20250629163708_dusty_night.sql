/*
  ...
  1. Sample Data
    - Insert sample categories (Technology, Business, Design, etc.)
    - Insert sample instructors with realistic profiles
    - Insert sample courses with proper relationships
