...
ALTER TABLE categories ADD CONSTRAINT categories_name_key UNIQUE (name) IF NOT EXISTS;
ALTER TABLE instructors ADD CONSTRAINT instructors_email_key UNIQUE (email) IF NOT EXISTS;
